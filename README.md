...
Health Tracker is a simple Java desktop application that allows users to manage personal health data such as weight, blood pressure, and exercise.
...
Provide data storage between sessions using a database
...
Save and load data (SQLite database)
